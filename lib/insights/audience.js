...
Audience.prototype.createUserSegment = function (name) {
  ...
  return this.post('insights/audience/segments', {
    name: name
  });
};
...
Audience.prototype.appendUsersToSegment = function (id, ids) {
  ...
  return this.post('insights/audience/segments/' + id + '/ids', {
    user_ids: ids
  });
};
...
Audience.prototype.createAudience = function (name, segments) {
  ...
  return this.post('insights/audience/audiences', {
    name: name,
...
Audience.prototype.query = function (id, groupings) {
  ...
  return this.post('insights/audience/audiences/' + id + '/query', {
    groupings: groupings
  });
}
